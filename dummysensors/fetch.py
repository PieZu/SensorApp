...
def temp():
    ...
    x = time()
    return cos(x/2) + 2*cos(x/5) + sin(x/7) + 3*cos(x/19) + sin(x/37) + cos((x-1)/61) + 4*sin(x/71) + 8*sin(x//331)*cos((x-2)/29) + cos(cos(x))*sin(x/577) + 30 -(x %(100 * (min(abs(1/cos(x/2000)), 3)/2+2)))/20
